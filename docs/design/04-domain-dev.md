...
| Kill switch | `iai dev abort --story 57` — converts every open PR under the Story back to draft, removes `gate:approved`, applies `status:blocked`, and posts the reason under `## iai-gate` |
