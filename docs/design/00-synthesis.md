...
| **Fabric** — 314 prompt pattern files | **DROP** | Out of scope. It is a prompt library, not a workflow system, and it duplicates what Tier-2 leaf skills do with worse traceability. Users who want Fabric can keep running Fabric |
